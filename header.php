...
<head>
    ...
    <!-- ogp -->
    <meta property="og:site_name" content="地域のコンビニ" />
    <meta property="og:url" content="https://jijisite.com/sample-store/" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="地域のコンビニ" />
    <meta property="og:description" content="手作り商品と、地域のみなさまに寄り添うお店です。" />
    <meta property="og:image" content="https://jijisite.com/sample-store/img/ogp.png" />
    <meta property="og:locale" content="ja_JP" />
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="地域のコンビニ">
    <meta name="twitter:description" content="手作り商品と、地域のみなさまに寄り添うお店です。">
    <meta name="twitter:image" content="https://jijisite.com/sample-store/img/ogp.png">
        ...
        <header class="header l-container">
            ...
            <nav class="header-nav">
                ...
                <ul class="header-menu">
                    ...
                    <li><a href="<?php echo home_url('/#top-products'); ?>">商品紹介</a></li>
                    <li><a href="<?php echo home_url('/#top-service'); ?>">サービス</a></li>
                    <li><a href="<?php echo home_url('/#top-access'); ?>">店舗案内</a></li>
                    <li><a href="<?php echo home_url('/#top-work'); ?>">採用情報</a></li>
